...
"""
@Author  : bettenW 
@E-Mail  : https://github.com/bettenW
"""
...
"""
借鉴一下bettenW使用Sigmoid()进行模型融合的技术~
"""
...
# 反sigmoid融合,当模型的效果差异比较小时采取此方法
"""
待优化的点：可以使用机器学习的方式来进行模型融合，比如使用LR来学习一个weight_vector，参见blend.py
"""
for i in range(10):
